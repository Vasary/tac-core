...
final class Version20220928124930 extends AbstractMigration
{
    ...
    {
        $this->addSql(
            'CREATE TABLE products (id UUID NOT NULL, creator_id UUID DEFAULT NULL, category_id UUID DEFAULT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, deleted_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, PRIMARY KEY(id))'
        );
        ...
        $this->addSql(
            'CREATE TABLE glossary (id UUID NOT NULL, parent_id UUID NOT NULL, locale VARCHAR(255) NOT NULL, field VARCHAR(255) NOT NULL, value VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))'
        );
        $this->addSql(
            'CREATE UNIQUE INDEX uniq_b0850b43727aca704180c6985bf54558 ON glossary (parent_id, locale, field)'
        );
        ...
        $this->addSql(
            'CREATE TABLE products_to_units (product_id UUID NOT NULL, unit_id UUID NOT NULL, PRIMARY KEY(product_id, unit_id))'
        );
        ...
        $this->addSql(
            'CREATE TABLE attributes_values (id UUID NOT NULL, creator_id UUID DEFAULT NULL, attribute_id UUID DEFAULT NULL, product_id UUID DEFAULT NULL, value VARCHAR(255) DEFAULT NULL, parent UUID DEFAULT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, deleted_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, PRIMARY KEY(id))'
        );
        ...
        $this->addSql(
            'CREATE TABLE attributes (id UUID NOT NULL, creator_id UUID DEFAULT NULL, code VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, deleted_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, PRIMARY KEY(id))'
        );
        ...
        $this->addSql(
            'CREATE TABLE categories (id UUID NOT NULL, creator_id UUID DEFAULT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, deleted_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, PRIMARY KEY(id))'
        );
        ...
        $this->addSql(
            'CREATE TABLE units (id UUID NOT NULL, creator_id UUID DEFAULT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, deleted_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, suggestions JSON NOT NULL, PRIMARY KEY(id))'
        );
        ...
        $this->addSql(
            'CREATE TABLE users (id UUID NOT NULL, email VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, deleted_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, PRIMARY KEY(id))'
        );
