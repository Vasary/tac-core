...
final class Factory extends FakerFactory
{
    public static function create($locale = FakerFactory::DEFAULT_LOCALE): Generator
    {
        ...
        $generator->addProvider(new UUIDv4($generator));
        $generator->addProvider(new LocalizationProvider($generator));
        $generator->addProvider(new UnitProvider($generator));
        $generator->addProvider(new AttributeProvider($generator));
